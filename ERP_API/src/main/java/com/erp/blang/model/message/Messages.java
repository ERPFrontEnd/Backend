package com.erp.blang.model.message;
...
public class Messages implements Serializable {
	 ...
	 */
	private Messages(MessageBuilder builder) {
	...
	/**
	 * A class that creates an instance of {@link Messages} with the properties that are not null.
	 */
	@JsonIgnoreType
